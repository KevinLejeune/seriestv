 ...
 */
class Serie extends \BackendBundle\Entity\Serie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\Serie' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\Serie' . "\0" . 'nom', '' . "\0" . 'BackendBundle\\Entity\\Serie' . "\0" . 'date', '' . "\0" . 'BackendBundle\\Entity\\Serie' . "\0" . 'affiche'];
        }
