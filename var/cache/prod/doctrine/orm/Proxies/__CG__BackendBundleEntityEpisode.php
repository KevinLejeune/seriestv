 ...
 */
class Episode extends \BackendBundle\Entity\Episode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\Episode' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\Episode' . "\0" . 'number', '' . "\0" . 'BackendBundle\\Entity\\Episode' . "\0" . 'name', '' . "\0" . 'BackendBundle\\Entity\\Episode' . "\0" . 'duration', '' . "\0" . 'BackendBundle\\Entity\\Episode' . "\0" . 'serie', '' . "\0" . 'BackendBundle\\Entity\\Episode' . "\0" . 'saison', '' . "\0" . 'BackendBundle\\Entity\\Episode' . "\0" . 'episodePeoples'];
        }
